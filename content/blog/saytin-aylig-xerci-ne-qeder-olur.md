...
Bu xərclər Tezsayt-dan asılı deyil. Saytınız kimdə hazırlanıbsa hazırlansın, bunları ödəməlisiniz:

| Xərc | Təxmini məbləğ | Tezlik |
|---|---|---|
| Domen (.az) | ~15 AZN | İldə bir dəfə |
| Domen (.com) | ~20–30 AZN | İldə bir dəfə |
...
## İxtiyari dəstək xidmətləri

Tezsayt yayımdan sonra 30 təqvim günü pulsuz dəstək verir — sadəcə xəta deyil, həqiqi dəyişikliklər. Ondan sonra iki seçim var:

1. **İxtiyari aylıq dəstək xidmətləri** — aşağıda siyahısı var
2. **Hər dəyişiklik üçün ayrıca ödəniş** — plan almadan, lazım olanda ödəyirsiniz

Heç bir məcburi abunəlik yoxdur. Üçüncü seçim — heç nə almamaq. Sayt sizindir, istəsəniz özünüz idarə edirsiniz.
...
Yoxdur. Tezsayt-ın qiymət modeli belədir:
...
- Sayt sizindir — planla və ya plansız
