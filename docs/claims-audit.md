...
Verified 2026-09-19. Every factual and comparative claim currently published.

## §6 Contradictions — confirmation status

### C1. "tam sayt 7 günə hazır olur" — CONFIRMED, CONTRADICTED
...
### C2. "1 həftə" in comparison table — CONFIRMED, CONTRADICTED
...
### C3. "5 səhifəlik sayt üçün 6 həftə gözləməyəcəksiniz" — CONFIRMED, CONTRADICTED
...
### C4. "Ənənəvi agentlik 2000+ AZN" — CONFIRMED, CONTRADICTED
...
### C5. Two support structures — CONFIRMED
...
### C6. "Ən populyar" badge — CONFIRMED, UNSUPPORTED
...
### C7. "1 saniyədən az yüklənmə vaxtı" — CONFIRMED, CONTRADICTED
...
### C9. "Care Plan — Basic" in English — CONFIRMED
...
### C10. "Pulsuz nümunənin tutduğu nədir?" — CONFIRMED
...
### C11. "Real bizneslər, real saytlar, hazırda yayında" — OK (verified)
...
### C12. Logo wall — CONFIRMED UNLABELED
...
### C13. "Kodun təkrarlanan hissələrini AI ilə idarə edirik, buna görə də 2 ay əvəzinə 1 həftədə təhvil verə bilirik"
**Where:** `locales/az.json` home.team.body2.
**Issue:** "1 həftədə" is another single-number turnaround claim. Same pattern as C1.

### C14. "Azərbaycan biznesləri üçün veb-saytlar. 7 günə hazır. 500 AZN-dən başlayaraq."
...
### C16. About page "Why AI" as a headline section — present
...
### C17. "Hər şey sizə məxsusdur" / "Всё принадлежит вам" / "You own everything"
...
### C18. Hardcoded competitor prices in story
...
| # | Claim | Verdict |
|---|---|---|
| C1 | "7 days" for full site | CONTRADICTED |
| C2 | "1 week" comparison | CONTRADICTED |
| C3 | "6 weeks for 5 pages" framing | CONTRADICTED (misleading) |
| C4 | "2000+ AZN" as bad price | CONTRADICTED (we charge it) |
| C5 | Two support structures | CONTRADICTED (inconsistent) |
| C6 | "Most popular" badge | UNSUPPORTED |
| C7 | "Under 1 second load" | CONTRADICTED (measured 2.3–5.5s) |
| C8 | "isteğe bağlı" spelling | CONFIRMED (Turkish) |
| C9 | "Care Plan — Basic" English | CONFIRMED |
| C10 | "tutduğu" calque | CONFIRMED |
| C11 | Portfolio all live | OK |
| C12 | Logo wall unlabeled | CONFIRMED |
| C13 | "1 week" in team body | CONTRADICTED |
| C14 | JSON-LD "7 days" | CONTRADICTED |
| C15 | Response time promise | UNVERIFIED |
| C16 | AI as about-page pillar | Placement issue (§8) |
| C17 | Ownership without exit mechanic | INCOMPLETE |
| C18 | Hardcoded competitor prices | Maintenance risk |
| C19 | "Open pricing" | OK |
| C20 | 50/50 payment stated as fact | PREMATURE (§12 #4 undecided) |
